        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
              ...
              <li class="nav-item ">
                <a class="nav-link active text-dark" aria-current="page" href="about.php">ABOUT US</a>
              </li>
              <li class="nav-item">
...
<br>
 ...
 <section>
    <div class="container" data-aos="fade-up">
        <div class="row align-items-center justify-content-center about-us-content">
          <h2 class="text-center"><b>About Us</b></h2><br><br><hr>
          <p style="font-size: 17px;">Play is the fundamental human need just as are food, clothing, shelter and education. And this forms the fundamental behind coming together of a passionate set of people and ideas to form <strong>Nebula Sports &#8211</strong> the World&#8217;s largest youth sports platform that is trying to make the world a better place.</strong></p>
          <img class="img-fluid mb-4" src="img\about-us.png" alt="">
        </div>
