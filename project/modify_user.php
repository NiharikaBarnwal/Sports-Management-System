...
<br>
<h2 class="text-center"><b>User Modification</b></h2><hr>
...
<?php
    while($result_array_row = mysqli_fetch_array($result)) {
        echo "<tr>";
        echo '<td>'.$result_array_row['user_id'].'</td>';
        ...
        echo '<td><a href=user_form.php?user_id='.$result_array_row['user_id'].'>Edit</a></td>';
        echo '<td><a href=delete_user.php?user_id='.$result_array_row['user_id'].'>Delete</a></td>';
        echo '</tr>';
    }
